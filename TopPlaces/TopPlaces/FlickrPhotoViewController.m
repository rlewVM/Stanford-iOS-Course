...
{
    if ([sender isKindOfClass:[UITableViewCell class]] && [segue.destinationViewController isKindOfClass:[ImageViewController class]]) {
        UITableViewCell *cell = (UITableViewCell *)sender;
        ImageViewController *photoVC = (ImageViewController *)segue.destinationViewController;
